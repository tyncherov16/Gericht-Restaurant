    ...
    (() => {
        ...
        class Popup {
            ...
            open(selectorValue) {
                ...
                if (this.targetOpen.element) {
                    if (this.targetOpen.element.hasAttribute(this.options.youtubeAttribute)) {
                        ...
                        if (this.targetOpen.element.querySelector(`.${this.options.classes.popupVideo}`)) this.targetOpen.element.querySelector(`.${this.options.classes.popupVideo}`).appendChild(iframe);
                    }
            ...
            close(selectorValue) {
                ...
                if (this.targetOpen.element.hasAttribute(this.options.youtubeAttribute)) if (this.targetOpen.element.querySelector(`.${this.options.classes.popupVideo}`)) this.targetOpen.element.querySelector(`.${this.options.classes.popupVideo}`).innerHTML = "";
        ...
        const initPopups = (logging = false, init = true) => new Popup({
            logging,
            init
        });
        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 500, offset = 0) => {
            ...
            } else console.log(`[gotoBlock]: Такого блока нет на странице: ${targetBlock}`);
        };
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    } else this.setLogging("Нет ни одного select. Сплю...zzZZZzZZz...");
                }
            }
...
***************************************************************************** */
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery__slider")) {
                let gallerySlider = new core(".gallery__slider", {
                ...
                function gallerySliderFix() {
                    ...
                    if (diff > 0) document.querySelector(".gallery__slider").style.width = document.querySelector(".gallery__body").offsetWidth + diff + 15 + "px"; else document.querySelector(".gallery__slider").style.width = document.querySelector(".gallery__body").offsetWidth + 15 + "px";
                }
        ...
        function pageNavigation() {
            ...
            function pageNavigationAction(e) {
                ...
                } else if (e.type === "watcherCallback") if (e.detail) {
        ...
        function bgParallax() {
            ...
            if (bgItems.length) document.addEventListener("windowScroll", (function(e) {
                bgItems.forEach((bgItem => {
                    ...
                    if (bgItemBg) if (scrollY > bgItemPosition - window.innerHeight && scrollY < bgItemPosition + bgItemHeight) bgItemBg.style.cssText = `transform: translate3D(0,${bgItemPositionValue}px,0);`;
                }));
            }));
        }
        setTimeout((() => {
